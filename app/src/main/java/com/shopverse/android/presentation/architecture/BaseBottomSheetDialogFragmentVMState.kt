...
abstract class BaseBottomSheetDialogFragmentVMState<V : View, Model, VM : BaseViewModelState<Model, *>> :
    BaseBottomSheetDialogFragmentVM<V, VM>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (rootView as? ViewStateRenderer<Model>)?.let { viewRenderer ->
            viewModel.viewStateFlow
                ...
                .onEach { viewState ->
                    val tag = this@BaseBottomSheetDialogFragmentVMState.TAG
